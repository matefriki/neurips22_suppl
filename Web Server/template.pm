...
const int block_x1 = {top_corner_x}; // crosswalk_pos - 20;
const int block_y1 = {top_corner_y}; // sidewalk_height;
const int block_x2 = {bottom_corner_x}; // block_x1 + block_width;
const int block_y2 = {bottom_corner_y}; // sidewalk_height + block_height;
...
module Car
	...
	car_y : [sidewalk_height..world_height-sidewalk_height] init {car_y};
...
module Pedestrian
	ped_x : [0..street_length] init {person_x}; // crosswalk_width / 2 = 10/2 = 5
